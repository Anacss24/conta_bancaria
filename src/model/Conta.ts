export abstract class Conta{
    // Definir os Atributos da Classe (Caracteristicas do objeto)
   ...
   // Definimos o método Construtor, responsável por criar os obletos da Classe 
    ...
    // Método para visualizar todos dos dados do objetos
